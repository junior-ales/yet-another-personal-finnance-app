declare module 'react-vis' {
  ...
  export class CircularGridLines extends React.Component<
    PropsCircularGridLines
  > {}
  ...
  export class FlexibleHeightXYPlot extends React.Component<
    PropsFlexibleHeightXYPlot
  > {}

  export class Voronoi extends React.Component<PropsVoronoi> {}

  export class FlexibleWidthXYPlot extends React.Component<
    PropsFlexibleWidthXYPlot
  > {}
  ...
  export class HorizontalBarSeries extends React.Component<
    PropsHorizontalBarSeries
  > {}

  export class HorizontalBarSeriesCanvas extends React.Component<
    PropsHorizontalBarSeriesCanvas
  > {}

  export class HorizontalGridLines extends React.Component<
    PropsHorizontalGridLines
  > {}

  export class HorizontalRectSeries extends React.Component<
    PropsHorizontalRectSeries
  > {}

  export class HorizontalRectSeriesCanvas extends React.Component<
    PropsHorizontalRectSeriesCanvas
  > {}
  ...
  export class LineMarkSeriesCanvas extends React.Component<
    PropsLineMarkSeriesCanvas
  > {}

  export class LineSeries extends React.Component<PropsLineSeries> {}

  export class LineSeriesCanvas extends React.Component<
    PropsLineSeriesCanvas
  > {}

  export class MarkSeries extends React.Component<PropsMarkSeries> {}

  export class MarkSeriesCanvas extends React.Component<
    PropsMarkSeriesCanvas
  > {}

  export class ParallelCoordinates extends React.Component<
    PropsParallelCoordinates
  > {}

  export class DiscreteColorLegend extends React.Component<PropsDiscreteColorLegend> {}
  ...
  // T is the data type
  export class RadialChart<T = PropsRadialChartData> extends React.Component<PropsRadialChart<T>> {}

  export class RectSeries extends React.Component<PropsRectSeries> {}

  export class RectSeriesCanvas extends React.Component<
    PropsRectSeriesCanvas
  > {}
  ...
  export class VerticalBarSeries extends React.Component<
    PropsVerticalBarSeries
  > {}

  export class VerticalGridLines extends React.Component<
    PropsVerticalGridLines
  > {}

  export class VerticalBarSeriesCanvas extends React.Component<
    PropsVerticalBarSeriesCanvas
  > {}

  export class VerticalRectSeries extends React.Component<
    PropsVerticalRectSeries
  > {}

  export class VerticalRectSeriesCanvas extends React.Component<
    PropsVerticalRectSeriesCanvas
  > {}
  ...
  export type PropsBaseSeries<T extends Object = Object> = {
    data: Array<T>;
    ...
    onNearestX?: (datapoint: T, info: InfoObject) => void;

    onValueMouseOver?: (datapoint: T, info: BaseInfoObject) => void;

    onValueMouseOut?: (datapoint: T, info: BaseInfoObject) => void;

    onValueClick?: (datapoint: T, info: BaseInfoObject) => void;

    onSeriesMouseOver?: (info: BaseInfoObject) => void;

    onSeriesMouseOut?: (info: BaseInfoObject) => void;

    onSeriesClick?: (info: BaseInfoObject) => void;
  ...
  export type PropsDiscreteColorLegend = {
    ...
    items?: Array<
      string | { title: string; color: String; disabled: boolean } | Element
    >;

    onItemClick?:
      | ((arg0: any, arg1: Object, arg2: any, arg3: number) => any)
      | undefined;
  ...
  export type PropsRadialChartData = {
    angle?: number;
  ...
  export type PropsRadialChart<T> = Partial<
    PropsBaseSeries<T | PropsRadialChartData | T & PropsRadialChartData>
  > & {
    angle?: any;
